...
$about_title  = 'Especialistas en Confección Técnica a Medida';
$about_text   = '<p class="rb-paragraph"><strong>ROLBAG</strong> fue fundada por <strong>Rolando Álvarez</strong> en el año <strong><?php echo esc_html( $stat2_num ); ?></strong> como un emprendimiento forjado tras décadas de experiencia en confección artesanal de calzado, bolsos y estuches de alta precisión.</p>
...
$stat3_num    = '100%';
$stat3_lbl    = 'Cobertura y despachos a todo Chile';

$mission      = 'Confeccionar productos exclusivos que brinden una mayor durabilidad y calidad, resguardando la inversión tecnológica y la continuidad operativa de nuestros clientes en todo Chile.';
$vision       = 'Satisfacer los requerimientos especiales y exclusivos que demandan las operaciones de nuestros clientes, innovando en soluciones personalizadas tales como arneses corporales, soportes para grúas y valijas con compartimentos de seguridad satelital.';
?>
